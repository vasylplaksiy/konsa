...
var snippets = {
    ...
    strReplaceAll: function () {
        String.prototype.strReplaceAll = function (search, replace) {
    ...
    getScrollBarWidth: function () {
        ...
        window.getScrollBarWidth = w1 - w2;
    }
}

$(document).ready(function () {
    snippets.strReplaceAll();
    snippets.getScrollBarWidth();
})